...
#define DISTRIBUTION_SHORT_NAME "fisher_f"
#define DISTRIBUTION_TEXT       string(string(DISTRIBUTION_SHORT_NAME) + " distribution")
#define DISTRIBUTION_NAME       fisher_f_distribution
...
struct distribution_traits_base {
	...
	static constexpr std::array<const char *, 2> param_names = {"d1", "d2"};
	...
	static void ValidateParameters(param1_t d1, param2_t d2) {
		if (d1 <= 0) {
			throw InvalidInputException(string(DISTRIBUTION_SHORT_NAME) +
			                            ": d1 must be > 0 was: " + std::to_string(d1));
		}
		if (d2 <= 0) {
			throw InvalidInputException(string(DISTRIBUTION_SHORT_NAME) +
			                            ": d2 must be > 0 was: " + std::to_string(d2));
		}
	}
};
...
LOAD_DISTRIBUTION_FN {
	...
	REGISTER(
	    ...
	    "Generates random samples from the " + DISTRIBUTION_TEXT + " with specified parameters.", "sample(5, 10)");
	...
	REGISTER(loader, "pdf", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "pdf(5, 10, 0.5)", param_names_unary);
	...
	REGISTER(
	    ...
	    "log_pdf(5, 10, 0.5)", param_names_unary);
	...
	REGISTER(loader, "cdf", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "cdf(5, 10, 0.5)", param_names_unary);
	...
	REGISTER(loader, "cdf_complement", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "cdf_complement(5, 10, 0.5)", param_names_unary);
	...
	REGISTER(
	    ...
	    "log_cdf(5, 10, 0.5)", param_names_unary);
	...
	REGISTER(loader, "log_cdf_complement", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "log_cdf_complement(5, 10, 0.5)", param_names_unary);
	...
	REGISTER(
	    ...
	    "quantile(5, 10, 0.95)", param_names_quantile);
	...
	REGISTER(loader, "quantile_complement", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "quantile_complement(5, 10, 0.05)", param_names_quantile);
	...
	REGISTER(
	    ...
	    "Computes the hazard function of the " + DISTRIBUTION_TEXT + ".", "hazard(5, 10, 0.5)", param_names_unary);
	...
	REGISTER(loader, "chf", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Computes the cumulative hazard function of the " + DISTRIBUTION_TEXT + ".", "chf(5, 10, 0.5)",
	         param_names_unary);
	...
	REGISTER(loader, "variance", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the variance (σ²) of the " + DISTRIBUTION_TEXT + ".", "variance(5, 10)");
	...
	REGISTER(loader, "skewness", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the skewness of the " + DISTRIBUTION_TEXT + ".", "skewness(5, 10)");
	...
	REGISTER(loader, "kurtosis", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the kurtosis of the " + DISTRIBUTION_TEXT + ".", "kurtosis(5, 10)");
	...
	REGISTER(loader, "kurtosis_excess", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the excess kurtosis of the " + DISTRIBUTION_TEXT + ".", "kurtosis_excess(5, 10)");
	...
	REGISTER(loader, "range", FunctionStability::CONSISTENT, LogicalType::ARRAY(LogicalType::DOUBLE, 2),
	         ...
	         "Returns the range of the " + DISTRIBUTION_TEXT + ".", "range(5, 10)");
	...
	REGISTER(loader, "support", FunctionStability::CONSISTENT, LogicalType::ARRAY(LogicalType::DOUBLE, 2),
	         ...
	         "Returns the support of the " + DISTRIBUTION_TEXT + ".", "support(5, 10)");
}
