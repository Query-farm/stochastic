...
#define DISTRIBUTION_SHORT_NAME "bernoulli"
#define DISTRIBUTION_TEXT       string(string(DISTRIBUTION_SHORT_NAME) + " distribution")
#define DISTRIBUTION_NAME       bernoulli_distribution

#define DISTRIBUTION        boost::math::DISTRIBUTION_NAME<double>
#define SAMPLE_DISTRIBUTION std::bernoulli_distribution
...
struct distribution_traits_base {
	...
	static constexpr std::array<const char *, 1> param_names = {"p"};
	...
	static void ValidateParameters(param1_t p) {
		if (p < 0 || p > 1) {
			throw InvalidInputException(string(DISTRIBUTION_SHORT_NAME) +
			                            ": Probability must be between 0 and 1 was: " + std::to_string(p));
		}
	}
};
...
LOAD_DISTRIBUTION_FN {
	...
	REGISTER(
	    loader, "sample", FunctionStability::VOLATILE, LogicalType::BOOLEAN,
	    [](DataChunk &args, ExpressionState &state, Vector &result) {
		    DistributionSampleUnary<SAMPLE_DISTRIBUTION, bool>(args, state, result);
	    },
	    "Generates random samples from the " + DISTRIBUTION_TEXT + " with specified parameters.", "sample(0.5)");
	...
	REGISTER(
	    ...
	    "log_pdf(0.5, 1)", param_names_unary);
	...
	REGISTER(loader, "cdf_complement", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "cdf_complement(0.5, 0)", param_names_unary);
	...
	REGISTER(
	    ...
	    "log_cdf(0.5, 0)", param_names_unary);
	...
	REGISTER(loader, "log_cdf_complement", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "log_cdf_complement(0.5, 0)", param_names_unary);
	...
	REGISTER(
	    ...
	    "quantile(0.5, 0.95)", param_names_quantile);
	...
	REGISTER(loader, "quantile_complement", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "quantile_complement(0.5, 0.05)", param_names_quantile);
	...
	REGISTER(
	    ...
	    "Computes the hazard function of the " + DISTRIBUTION_TEXT + ".", "hazard(0.5, 0)", param_names_unary);
	...
	REGISTER(loader, "chf", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Computes the cumulative hazard function of the " + DISTRIBUTION_TEXT + ".", "chf(0.5, 0)",
	         param_names_unary);
	...
	REGISTER(loader, "mean", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the mean (μ) of the " + DISTRIBUTION_TEXT + ", which is the first moment.", "mean(0.5)");
	...
	REGISTER(loader, "stddev", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the standard deviation (σ) of the " + DISTRIBUTION_TEXT + ".", "stddev(0.5)");
	...
	REGISTER(loader, "variance", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the variance (σ²) of the " + DISTRIBUTION_TEXT + ".", "variance(0.5)");
	...
	REGISTER(loader, "skewness", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the skewness of the " + DISTRIBUTION_TEXT + ".", "skewness(0.5)");
	...
	REGISTER(loader, "kurtosis", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the kurtosis of the " + DISTRIBUTION_TEXT + ".", "kurtosis(0.5)");
	...
	REGISTER(loader, "kurtosis_excess", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the excess kurtosis of the " + DISTRIBUTION_TEXT + ".", "kurtosis_excess(0.5)");
	...
	REGISTER(loader, "range", FunctionStability::CONSISTENT, LogicalType::ARRAY(LogicalType::DOUBLE, 2),
	         ...
	         "Returns the range of the " + DISTRIBUTION_TEXT + ".", "range(0.5)");
	...
	REGISTER(loader, "support", FunctionStability::CONSISTENT, LogicalType::ARRAY(LogicalType::DOUBLE, 2),
	         ...
	         "Returns the support of the " + DISTRIBUTION_TEXT + ".", "support(0.5)");
}
