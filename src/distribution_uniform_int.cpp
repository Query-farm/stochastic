...
template <>
struct distribution_traits<boost::math::uniform_distribution<int64_t>> {
	using param1_t = int64_t;
	using param2_t = int64_t;
...
template <>
struct distribution_traits<boost::random::uniform_int_distribution<int64_t>> {
	using param1_t = int64_t;
	using param2_t = int64_t;
...
LOAD_DISTRIBUTION_FN {
	...
	REGISTER(
	    instance, "sample", FunctionStability::VOLATILE, LogicalType::BIGINT,
	...
	// === QUANTILE FUNCTIONS ===
	REGISTER(
	    instance, "quantile", FunctionStability::CONSISTENT, LogicalType::BIGINT,
	...
	REGISTER(instance, "quantile_complement", FunctionStability::CONSISTENT, LogicalType::BIGINT,
	...
	REGISTER(instance, "mean", FunctionStability::CONSISTENT, LogicalType::BIGINT,
	...
	REGISTER(instance, "stddev", FunctionStability::CONSISTENT, LogicalType::BIGINT,
	...
	REGISTER(instance, "variance", FunctionStability::CONSISTENT, LogicalType::BIGINT,
	...
	REGISTER(instance, "mode", FunctionStability::CONSISTENT, LogicalType::BIGINT,
	...
	REGISTER(instance, "median", FunctionStability::CONSISTENT, LogicalType::BIGINT,
	...
	REGISTER(instance, "range", FunctionStability::CONSISTENT, LogicalType::ARRAY(LogicalType::BIGINT, 2),
	         make_none([](const auto &dist) { return boost::math::range(dist); }),
	         "Returns the range of the " + DISTRIBUTION_TEXT + ".", "range(0.0, 1.0)");

	REGISTER(instance, "support", FunctionStability::CONSISTENT, LogicalType::ARRAY(LogicalType::BIGINT, 2),
