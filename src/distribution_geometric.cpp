...
#define DISTRIBUTION_SHORT_NAME "geometric"
#define DISTRIBUTION_TEXT       string(string(DISTRIBUTION_SHORT_NAME) + " distribution")
#define DISTRIBUTION_NAME       geometric_distribution
#define DISTRIBUTION            boost::math::DISTRIBUTION_NAME<double>
#define SAMPLE_DISTRIBUTION     std::geometric_distribution<int64_t>
...
LOAD_DISTRIBUTION_FN {
	...
	REGISTER(
	    ...
	    [](DataChunk &args, ExpressionState &state, Vector &result) {
		    DistributionSampleUnary<SAMPLE_DISTRIBUTION, int64_t>(args, state, result);
	    },
	...
	REGISTER(
	    ...
	    "log_pdf(0.5, 2)", param_names_unary);
	...
	REGISTER(loader, "cdf_complement", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "cdf_complement(0.5, 2)", param_names_unary);
	...
	REGISTER(
	    ...
	    "log_cdf(0.5, 2)", param_names_unary);
	...
	REGISTER(loader, "log_cdf_complement", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "log_cdf_complement(0.5, 2)", param_names_unary);
	...
	REGISTER(
	    ...
	    "Computes the hazard function of the " + DISTRIBUTION_TEXT + ".", "hazard(0.5, 2)", param_names_unary);
	...
	REGISTER(loader, "chf", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Computes the cumulative hazard function of the " + DISTRIBUTION_TEXT + ".", "chf(0.5, 2)",
	         param_names_unary);
