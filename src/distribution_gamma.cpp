...
LOAD_DISTRIBUTION_FN {
	...
	REGISTER(
	    ...
	    "Generates random samples from the " + DISTRIBUTION_TEXT + " with specified parameters.", "sample(2.0, 1.0)");
	...
	REGISTER(loader, "pdf", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "pdf(2.0, 1.0, 1.5)", param_names_unary);
	...
	REGISTER(
	    ...
	    "log_pdf(2.0, 1.0, 1.5)", param_names_unary);
	...
	REGISTER(loader, "cdf", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "cdf(2.0, 1.0, 1.5)", param_names_unary);
	...
	REGISTER(loader, "cdf_complement", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "cdf_complement(2.0, 1.0, 1.5)", param_names_unary);
	...
	REGISTER(
	    ...
	    "log_cdf(2.0, 1.0, 1.5)", param_names_unary);
	...
	REGISTER(loader, "log_cdf_complement", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "log_cdf_complement(2.0, 1.0, 1.5)", param_names_unary);
	...
	REGISTER(
	    ...
	    "quantile(2.0, 1.0, 0.95)", param_names_quantile);
	...
	REGISTER(loader, "quantile_complement", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "quantile_complement(2.0, 1.0, 0.05)", param_names_quantile);
	...
	REGISTER(
	    ...
	    "Computes the hazard function of the " + DISTRIBUTION_TEXT + ".", "hazard(2.0, 1.0, 1.5)", param_names_unary);
	...
	REGISTER(loader, "chf", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Computes the cumulative hazard function of the " + DISTRIBUTION_TEXT + ".", "chf(2.0, 1.0, 1.5)",
	         param_names_unary);
	...
	REGISTER(loader, "mean", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the mean (μ) of the " + DISTRIBUTION_TEXT + ", which is the first moment.", "mean(2.0, 1.0)");
	...
	REGISTER(loader, "stddev", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the standard deviation (σ) of the " + DISTRIBUTION_TEXT + ".", "stddev(2.0, 1.0)");
	...
	REGISTER(loader, "variance", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the variance (σ²) of the " + DISTRIBUTION_TEXT + ".", "variance(2.0, 1.0)");
	...
	REGISTER(loader, "skewness", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the skewness of the " + DISTRIBUTION_TEXT + ".", "skewness(2.0, 1.0)");
	...
	REGISTER(loader, "kurtosis", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the kurtosis of the " + DISTRIBUTION_TEXT + ".", "kurtosis(2.0, 1.0)");
	...
	REGISTER(loader, "kurtosis_excess", FunctionStability::CONSISTENT, LogicalType::DOUBLE,
	         ...
	         "Returns the excess kurtosis of the " + DISTRIBUTION_TEXT + ".", "kurtosis_excess(2.0, 1.0)");
	...
	REGISTER(loader, "range", FunctionStability::CONSISTENT, LogicalType::ARRAY(LogicalType::DOUBLE, 2),
	         ...
	         "Returns the range of the " + DISTRIBUTION_TEXT + ".", "range(2.0, 1.0)");
	...
	REGISTER(loader, "support", FunctionStability::CONSISTENT, LogicalType::ARRAY(LogicalType::DOUBLE, 2),
	         ...
	         "Returns the support of the " + DISTRIBUTION_TEXT + ".", "support(2.0, 1.0)");
}
